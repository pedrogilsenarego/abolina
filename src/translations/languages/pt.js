    ...
    translations: {
      ...
      modules: {
        checkout: {
          ...
          discountTotal: "Valor do desconto:",
          total: "Valor Total:",
        ...
        cart: {
          ...
          table: {
            ...
            subtotal: "Subtotal",
            offer: "oferta",
            offerTooltip: "Será gerado um, ou mais, código(s) de oferta",
        ...
        login: {
          ...
          retrievePassword: "Recuperar a Palavra-passe",
          recoverPwdInfo:
            "(Receberá um link por e-mail para criar uma palavra-passe)",
        },
        home: {
        ...
        books: {
          ...
          book: {
            bookTitle: "Título",
            backCollection: "Voltar à colleção",
            backBooks: "Voltar aos livros",
            text: "Texto:",
            price: "Preço:",
            design: "Ilustração:",
            ...
            loading: "Estamos a procura do seu livro",
          },
          viewBook: {
            page: "PÁGINAS",
          },
